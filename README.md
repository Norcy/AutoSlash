...
```bash
curl -sL https://raw.githubusercontent.com/Norcy/AutoSlash/refs/heads/main/install.sh | bash
```
...
```bash
curl -sL https://raw.githubusercontent.com/Norcy/AutoSlash/refs/heads/main/uninstall.sh | bash
```
